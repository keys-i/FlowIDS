...
| NF-CSE-CIC-IDS2018-v3 | Sealed benchmark. | No pretraining, selection, threshold, or schema decision observes it before the sealed run. It remains benchmark evidence, not operational evidence. |
...
Exploration answers only: schema and labels, time order, missingness,
duplicates, field selection, and evaluation decisions. Existing DuckDB queries
are enough.
