...
Exploration uses the existing DuckDB queries to understand schema,
missingness, timestamps, labels, duplicates, and feature choices. Its output
informs M0 implementation.
